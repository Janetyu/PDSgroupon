...
func InitDockerRedis() (redis.Conn, error) {
	rc, err := redis.Dial(viper.GetString("docker_redis.network"), viper.GetString("docker_redis.addr"))
	return rc, err
}
...
func GetDockerRedis() (redis.Conn, error) {
	return InitDockerRedis()
}
